...
func file_graphql_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_graphql_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_graphql_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_graphql_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_graphql_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_graphql_proto_msgTypes[4].Exporter = func(v any, i int) any {
